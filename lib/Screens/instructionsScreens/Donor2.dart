...
class Donor2 extends StatelessWidget {
  const Donor2 ({Key? key}) : super(key: key);
  static const String id = 'Donor2';
  @override
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Label the food with type, date, and any relevant details.',
                style: TextStyle(
                  fontSize: fontSize,
                  fontWeight: FontWeight.bold,
                  color: Colors.black,
